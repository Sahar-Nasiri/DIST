...
Categories = [
['Cataract_split_2_train_multi_0.csv', 'Cataract_split_2_semi_multi_0.csv', 'Cataract_split_2_test_multi_0.csv', 1],
['Cataract_split_2_train_multi_1.csv', 'Cataract_split_2_semi_multi_1.csv', 'Cataract_split_2_test_multi_1.csv', 1],
['Cataract_split_2_train_multi_2.csv', 'Cataract_split_2_semi_multi_2.csv', 'Cataract_split_2_test_multi_2.csv', 1],
['Cataract_split_2_train_multi_3.csv', 'Cataract_split_2_semi_multi_3.csv', 'Cataract_split_2_test_multi_3.csv', 1]
]
