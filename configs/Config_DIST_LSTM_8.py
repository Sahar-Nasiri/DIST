...
from nets import VGG_LSTM as Net

Net1 = Net

Categories = [
['Cataract_split_8_train_multi_0.csv', 'Cataract_split_8_semi_multi_0.csv', 'Cataract_split_8_test_multi_0.csv', 1],
['Cataract_split_8_train_multi_1.csv', 'Cataract_split_8_semi_multi_1.csv', 'Cataract_split_8_test_multi_1.csv', 1],
['Cataract_split_8_train_multi_2.csv', 'Cataract_split_8_semi_multi_2.csv', 'Cataract_split_8_test_multi_2.csv', 1],
['Cataract_split_8_train_multi_3.csv', 'Cataract_split_8_semi_multi_3.csv', 'Cataract_split_8_test_multi_3.csv', 1]
]

# Categories = ['Phako','Rest']
